    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {showPopup && (
        <div 
          ...
          className="absolute top-12 right-0 w-[300px] sm:w-72 bg-white rounded-2xl shadow-brand-xl border border-surface-200 z-40 p-3 cursor-pointer hover:bg-surface-50 transition-all animate-fade-in group"
        >
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-[320px] sm:w-80 bg-white rounded-2xl shadow-brand-xl border border-surface-100 overflow-hidden z-50 animate-slide-down origin-top-right">
